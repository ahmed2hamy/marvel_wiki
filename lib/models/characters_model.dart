...
//
//     final charactersData = charactersDataFromJson(jsonString);

import 'dart:convert';

CharactersData charactersDataFromJson(String str) =>
    CharactersData.fromJson(json.decode(str));
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        urls: List<Urls>.from(json["urls"].map((x) => Urls.fromJson(x))),
      );
